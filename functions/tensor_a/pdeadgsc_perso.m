function [bt,errf_norm]=pdeadgsc_perso(p,t,c,a,f,u,errf,tol)
...
%       $Revision: 1.9.4.4 $  $Date: 2013/09/28 05:50:07 $
...
elseif nrc==4*N*N, % General (unsymmetric) c
  ...
  error(message('pde:pdeadgsc:NumRowsC'));
end % nrc
...
elseif nra==N*N, % General (unsymmetric) a
  ...
  error(message('pde:pdeadgsc:NumRowsA'));
end % nra
