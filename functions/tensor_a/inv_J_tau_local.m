function [u_res,p,t,e] = inv_J_tau_local(model_input)
...
fct_a_pde = @(P,T,u,time) ( coef_a * fct_tensor_a_pde(fct_grid_mesh(1/coef_x*P,T),model) );
...
%     [u_res,p,e,t] = adaptmesh_perso_old(dg,problem ,fct_a_pde , scalar_A , RHS , ...
%         'Tripick','pdeadgsc','maxt',6e5,'Ngen',inf,'par',1e-0,'Rmethod','longest');
%     [u_res,p,e,t] = adaptmesh_perso(dg,problem ,fct_a_pde , scalar_A , RHS , ...
%         'Tripick','pdeadgsc_perso','maxt',6e5,'Ngen',inf,'par',1e-1,'Rmethod','longest');
    [u_res,p,e,t] = adaptmesh_perso(dg,problem ,fct_a_pde , scalar_A , RHS , ...
        'Tripick','pdeadgsc_perso','maxt',6e5,'Ngen',inf,'par',4e-7,'Rmethod','longest');
% % %     [u_res,p,e,t] = adaptmesh_perso(dg,problem ,fct_a_pde , scalar_A , RHS , ...
% % %         'Tripick','pdeadgsc','maxt',10e5,'Ngen',inf,'par',1e-8,'Rmethod','longest');
% %     [u_res,p,e,t] = adaptmesh_perso(dg,problem ,fct_a_pde , scalar_A , RHS , ...
% %         'Tripick','pdeadgsc','maxt',6e5,'Ngen',inf,'par',2e-7,'Rmethod','longest');
% % %     [u_res,p,e,t] = adaptmesh_perso(dg,problem ,fct_a_pde , scalar_A , RHS , ...
% % %         'Tripick','pdeadgsc','maxt',5e5,'Ngen',inf,'par',4e-7,'Rmethod','longest');
% % %     %     [u_res,p,e,t] = adaptmesh_perso(dg,problem ,fct_a_pde , scalar_A , RHS , ...
% % %     %         'Tripick','pdeadworst','maxt',5e5,'Ngen',inf,'par',0.9,'Rmethod','regular');
% % %     %     [u_res,p,e,t] = adaptmesh(dg,problem ,fct_a_pde , scalar_A , RHS ,'maxt',5e5,'Ngen',inf,'par',0.5,'Rmethod','longest');
% % %     %     [u_res,p,e,t] = adaptmesh(dg,problem ,fct_a_pde , scalar_A , RHS ,'maxt',5e5,'Ngen',inf,'par',0.9,'Rmethod','regular');
% % %     %     [u_res,p,e,t] = adaptmesh(dg,problem ,fct_a_pde , scalar_A , RHS ,'maxt',5e5,'Ngen',inf,'par',1e-1,'Rmethod','regular');
% % %     %     [u_res,p,e,t] = adaptmesh(dg,problem ,fct_a_pde , scalar_A , RHS ,'maxt',5e5,'Ngen',20,'par',1e-1,'Rmethod','longest');
else
