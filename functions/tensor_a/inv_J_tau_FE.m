function [u_res,p,t,e] = inv_J_tau_FE(model_input)
...
if adaptative_mesh
    ...
    [u_res,p,e,t] = adaptmesh_perso(dg,problem ,fct_a_pde , scalar_A , RHS , ...
        'Tripick','pdeadgsc_perso','maxt',1e5,'Ngen',inf,'par',4e-1,'Rmethod','longest');
%     [u_res,p,e,t] = adaptmesh_perso(dg,problem ,fct_a_pde , scalar_A , RHS , ...
%         'Tripick','pdeadgsc_perso','maxt',7e6,'Ngen',inf,'par',4e-1,'Rmethod','longest');
%     [u_res,p,e,t] = adaptmesh_perso(dg,problem ,fct_a_pde , scalar_A , RHS , ...
