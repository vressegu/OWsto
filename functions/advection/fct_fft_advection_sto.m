...
if strcmp(model.type_data,'Back_grad')
    model_grad = model;
    model_grad.add_back_grad = true;
    model_grad.folder.folder_simu = ...
        [ model_grad.folder.folder_simu '/with_back_grad' ];
    fct_create_folder_plots(model_grad)
    clear model_grad
end
...
%     fft_buoy_part = fft_buoy_part - fft2(init_Back_grad(model,X,Y));
% end
...
for t=1:N_t
    ...
    if tt > tt_last
        ...
        if strcmp(model.type_data,'Back_grad')
            ...
            model_grad.folder.folder_simu = ...
                [ model_grad.folder.folder_simu '/with_back_grad' ];
            fct_plot(model_grad,fft_buoy_part,day);
            clear model_grad
        end
