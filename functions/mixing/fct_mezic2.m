function [alpha2_m, cax_alpha] = fct_mezic2(model,nabla_phi,t)
% function alpha2_m = fct_mezic2(model,X,t)
...
% %%
% nabla_phi = sum(sum(nabla_phi.^2,4),3);
% 
% figure;
% subplot(2,2,1);imagesc(x,y,nabla_phi(:,:,1,1)');axis xy; axis equal; drawnow;
% % subplot(2,2,1);imagesc(x,y,nabla_phi(:,:,1,1)');axis xy; axis equal; drawnow;
% % subplot(2,2,2);imagesc(x,y,nabla_phi(:,:,2,1)');axis xy; axis equal; drawnow;
% % subplot(2,2,1);imagesc(x,y,nabla_phi(:,:,1,1)');axis xy; axis equal; drawnow;
% % subplot(2,2,2);imagesc(x,y,nabla_phi(:,:,2,1)');axis xy; axis equal; drawnow;
% % subplot(2,2,3);imagesc(x,y,nabla_phi(:,:,1,2)');axis xy; axis equal; drawnow;
% % subplot(2,2,4);imagesc(x,y,nabla_phi(:,:,2,2)');axis xy; axis equal; drawnow;
% % keyboard;
