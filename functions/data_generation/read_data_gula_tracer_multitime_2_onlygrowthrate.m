function [salt,temp,model] = read_data_gula_tracer_multitime_2_onlygrowthrate()
...
%         end
%     end
    eval([ 'data_tot_smooth=' name_data ';']);
