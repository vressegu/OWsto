function high = ssh_data_obs(X,unity_approx,BOX)
...
if isempty (xref) || isempty (yref) || isempty (sshref) || ...
    ...
    time_step_choose=5;
    load('data/simu2008_30_noisy2.mat','ssh','dx','dy');
%     load('data/simu2008_30_noisy.mat','ssh','dx','dy');
    sshref=ssh(3:end,:,time_step_choose);
%     sshref=ssh(2:end-1,:,time_step_choose);
